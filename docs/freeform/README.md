...
<div class="breadcrumbs">
  <p>
    <a class="breadcrumbs-link" href="#">home</a> <a class="breadcrumbs-link" href="#">documents</a> page title lorem ipsum
  </p>
</div><!-- /.breadcrumbs -->
```
...
<div class="post">
  ...
  <!-- make sure this is a div with a height and width to it -->
  <div style="background: url('PATH TO THE IMAGE') center no-repeat; background-size: cover;"></div>
